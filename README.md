...
- **Real trade execution.** Would require integrating with an existing broker/trading API or direct broker-dealer registration — a significant, currently unresearched compliance undertaking, deliberately deferred.
